...
This example also includes JSON-LD annotations to associate the JSON structures with GeoJSON and Route vocabularies. For use in the Routing API it is essential that a route is still valid GeoJSON.
